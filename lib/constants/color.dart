...
const Color statusBarColor = Color(0xFFFFD233);
dynamic statusBarColorD =
    MaterialStateProperty.all<Color>(const Color(0xFFFFD233));
const Color backgroundColor = Color(0xff001F30);
const Color loginColor = Color(0xFF001521);
dynamic loginColorD = MaterialStateProperty.all<Color>(const Color(0xFF001521));
...
const Color greyBorderColor = Color(0xFFC4C4C4);
